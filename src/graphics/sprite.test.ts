...
test('syncDrawableFraction()', () => {
  for (const [xy, dir, x, out] of [
    ...
    [{x: -3.25, y: 0}, -1, 'x', {x: -3.25, y: 0.734375}],
    [{x: -3.25, y: 0}, 0, 'x', {x: -3.25, y: 0}],
    [{x: -3.25, y: 0}, 1, 'x', {x: -3.25, y: 0.25}],

    [{x: 3.25, y: 0}, -1, 'x', {x: 3.25, y: 0.734375}],
    [{x: 3.25, y: 0}, 0, 'x', {x: 3.25, y: 0}],
    [{x: 3.25, y: 0}, 1, 'x', {x: 3.25, y: 0.25}],

    [{x: 3.25, y: 0}, -1, 'y', {x: 3.984375, y: 0}],
    [{x: 3.25, y: 0}, 0, 'y', {x: 3.25, y: 0}],
    [{x: 3.25, y: 0}, 1, 'y', {x: 3, y: 0}],

    [{x: -3.25, y: -1}, -1, 'x', {x: -3.25, y: -1.734375}],
    [{x: -3.25, y: -1}, 0, 'x', {x: -3.25, y: -1}],
    [{x: -3.25, y: -1}, 1, 'x', {x: -3.25, y: -1.25}],
    ...
    [{x: 3.25, y: 1}, -1, 'y', {x: 3.984375, y: 1}],
    [{x: 3.25, y: 1}, 0, 'y', {x: 3.25, y: 1}],
    [{x: 3.25, y: 1}, 1, 'y', {x: 3, y: 1}]
  ] as const) {
    const copy = {...xy}
