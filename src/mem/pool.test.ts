...
test('alloc to capacity then free middle and realloc', () => {
  ...
  assert(pool.toDebugString(), '00 00')
  ...
  assert(pool.toDebugString(), '00 01 02 03 04 05')
  ...
  assert(pool.toDebugString(), '00 01 05 03 04 05')
  ...
  assert(pool.toDebugString(), '00 01 05 04')
  ...
  assert(pool.toDebugString(), '00 01 05 02')
  ...
  assert(pool.toDebugString(), '00 01 05 02 03 00')
  ...
  assert(pool.toDebugString(), '00 01 05 02 03 04')
})
