...
import { ShaderLayout, ShaderLayoutAttribute } from '@/void'
...
export const debugGL = true

export function initGLAttribute(
  gl: GL,
  stride: number,
  divisor: number,
  buffer: GLBuffer,
...
export function loadGLDataTexture(
  gl: GL,
  textureUnit: number,
...
export function getGLUniformLocations(
  gl: GL,
  program: GLProgram,
...
export function getGLUniformLocation(
  layout: ShaderLayout,
...
export function getGLAttributeLocations(
  gl: GL,
  program: GLProgram,
