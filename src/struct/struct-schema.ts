 ...
 *
 * props do not straddle word boundaries. byte aligned prop accessors are
 * optimized. structs are multiples of 4B. props are returned in big-endian.
 * structs can only be allocated as array buffers.
 *
